...
class Pricing_Table extends Widget_Base {
    ...
    {
        return esc_html__('Pricing Table', 'addonskit-kit-elementor');
    }
    ...
    protected function addonskit_table_pricing_settings() {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Settings', 'addonskit-kit-elementor'),
            ]
        );
        ...
        $pricing_style = apply_filters(
            ...
            [
                'styles'     => [
                    'style-1' => esc_html__('Default', 'addonskit-kit-elementor'),
                    'style-2' => esc_html__('Pricing Style 2', 'addonskit-kit-elementor'),
                    'style-3' => esc_html__('Pricing Style 3 ', 'addonskit-kit-elementor'),
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Pricing Style', 'addonskit-kit-elementor'),
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__('List Icon', 'addonskit-kit-elementor'),
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('List Icon Placement', 'addonskit-kit-elementor'),
                'type'        => Controls_Manager::SELECT,
                'default'     => 'left',
                'label_block' => false,
                'options'     => [
                    'left'  => esc_html__('Left', 'addonskit-kit-elementor'),
                    'right' => esc_html__('Right', 'addonskit-kit-elementor'),
                ],
                'condition'   => [
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => false,
                'default'     => esc_html__('Startup', 'addonskit-kit-elementor'),
                'ai' => [
					'active' => false,
				],
            ]
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Sub Title', 'addonskit-kit-elementor'),
                'type'        => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
                'label_block' => false,
                'default'     => esc_html__('A tagline here.', 'addonskit-kit-elementor'),
                'condition'   => [
        ...
        $this->add_control(
            ...
            [
                'label'            => esc_html__('Icon', 'addonskit-kit-elementor'),
    ...
    protected function addonskit_pricing_table_price() {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Price', 'addonskit-kit-elementor'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => false,
                'default'     => esc_html__('99', 'addonskit-kit-elementor'),
                'ai' => [
					'active' => false,
				],
            ]
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Price Currency', 'addonskit-kit-elementor'),
                'type'        => Controls_Manager::TEXT,
                'dynamic' => ['active' => true],
                'label_block' => false,
                'default'     => esc_html__('$', 'addonskit-kit-elementor'),
                'ai' => [
					'active' => false,
				],
            ]
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Price Period (per)', 'addonskit-kit-elementor'),
                'type'        => Controls_Manager::TEXT,
                'dynamic' => ['active' => true],
                'label_block' => false,
                'default'     => esc_html__('month', 'addonskit-kit-elementor'),
                'ai' => [
					'active' => false,
				],
            ]
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Period Separator', 'addonskit-kit-elementor'),
                'type'        => Controls_Manager::TEXT,
                'dynamic' => ['active' => true],
                'label_block' => false,
                'default'     => esc_html__('/', 'addonskit-kit-elementor'),
    ...
    protected function addonskit_pricing_table_feature() {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Feature', 'addonskit-kit-elementor'),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                'label'       => esc_html__( 'List Item', 'addonskit-kit-elementor' ),
                'type'        => Controls_Manager::TEXT,
                'dynamic' => ['active' => true],
                'label_block' => true,
                'default'     => esc_html__( 'Pricing table list item', 'addonskit-kit-elementor' ),
                'ai' => [
					'active' => false,
				],
            ]
    ...
    protected function addonskit_pricing_table_footerr() {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Button', 'addonskit-kit-elementor'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'        => __('Display Button', 'addonskit-kit-elementor'),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => __('Show', 'addonskit-kit-elementor'),
                'label_off'    => __('Hide', 'addonskit-kit-elementor'),
                'return_value' => 'yes',
                'default'      => 'yes',
                'selectors'    => [
        ...
        $this->add_control(
            ...
            [
                'label'            => esc_html__('Button Icon', 'addonskit-kit-elementor'),
                'type'             => Controls_Manager::ICONS,
				'default' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => 'left',
                'options'   => [
                    'left'  => esc_html__('Before', 'addonskit-kit-elementor'),
                    'right' => esc_html__('After', 'addonskit-kit-elementor'),
                ],
                'condition' => [
                    'addonskit_pricing_table_button_show'      => 'yes',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Button Text', 'addonskit-kit-elementor'),
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'dynamic' => ['active' => true],
                'default'     => esc_html__('Choose Plan', 'addonskit-kit-elementor'),
                'condition'   => [
                    'addonskit_pricing_table_button_show' => 'yes',
                ],
                'ai' => [
        ...
        $this->add_control(
            ...
            [
                'label'         => esc_html__('Button Link', 'addonskit-kit-elementor'),
    ...
    protected function addonskit_pricing_table_style_settings() {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Pricing Table Style', 'addonskit-kit-elementor'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Background Color', 'addonskit-kit-elementor'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label'      => esc_html__('Margin', 'addonskit-kit-elementor'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'    => esc_html__('Border Type', 'addonskit-kit-elementor'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Border Radius', 'addonskit-kit-elementor'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label'        => esc_html__('Content Alignment', 'addonskit-kit-elementor'),
                'type'         => Controls_Manager::CHOOSE,
                'label_block'  => true,
                'options'      => [
                    'left'   => [
                        'title' => esc_html__('Left', 'addonskit-kit-elementor'),
                        'icon'  => 'eicon-text-align-left',
                    ],
                    'center' => [
                        'title' => esc_html__('Center', 'addonskit-kit-elementor'),
                        'icon'  => 'eicon-text-align-center',
                    ],
                    'right'  => [
                        'title' => esc_html__('Right', 'addonskit-kit-elementor'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label'        => esc_html__('Button Alignment', 'addonskit-kit-elementor'),
                'type'         => Controls_Manager::CHOOSE,
                'label_block'  => true,
                'options'      => [
                    'left'   => [
