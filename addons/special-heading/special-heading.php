...
class Special_heading extends Widget_Base{
	...
	public function get_title(){
		return esc_html__('Addonskit Multi Color Heading', 'propuls-core');
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'title_first', [
				'label'       => esc_html__( 'Title (First part)', 'ropulse-core' ),
		...
		$this->add_control(
			'title_middle', [
				'label'       => esc_html__( 'Title (Middle part)', 'ropulse-core' ),
				'type'        => \Elementor\Controls_Manager::TEXTAREA,
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'title_last', [
				'label'       => esc_html__( 'Title (Last part)', 'ropulse-core' ),
				'type'        => \Elementor\Controls_Manager::TEXTAREA,
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('First part style', 'essential-addons-for-elementor-lite'),
        ...
        $this->add_control(
			'first_span_color',
			[
				'label'     => esc_html__( 'Color', 'ropulse-core' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Middle part style', 'essential-addons-for-elementor-lite'),
				'type' => Controls_Manager::HEADING,
			]
		);
		...
		$this->add_control(
			'middle_span_color',
			[
				'label'     => esc_html__( 'Title first middle color', 'ropulse-core' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Last part style', 'essential-addons-for-elementor-lite'),
				'type' => Controls_Manager::HEADING,
			]
		);
