...
class Addons_Manager {
    ...
    public static function initiate_widgets( $widgets_manager ){
		...
		require_once ADDONSKIT_ADDONS . 'our-services/our-services.php';
		...
		$widgets_manager->register( new \AddonsKit\Elementor\Widget\Our_Services() );
    ...
    public static function widget_map_free() {
        return [
            'section-heading'  => [
                'title'  => __( 'Testimonial Slider', 'addons-kit-elementor' ),
